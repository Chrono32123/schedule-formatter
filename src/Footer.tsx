  ...
  return (
    <Box component="footer" className="footer">
      ...
      <Box className="footer-social-links">
        <a 
          href="https://ko-fi.com/chrono_media" 
          target="_blank" 
        ...
        <a 
          href="https://discord.com/invite/HSKUEjk5K7" 
          target="_blank" 
          rel="noopener noreferrer"
          className="footer-social-link"
          aria-label="Join Discord"
        >
          <svg className="footer-social-icon discord-svg" viewBox="0 0 127.14 96.36" xmlns="http://www.w3.org/2000/svg">
